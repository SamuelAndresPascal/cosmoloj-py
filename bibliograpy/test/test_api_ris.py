...
def test_sample3():
    ...
    with open(Path(__file__).parent / 'resources' / 'ris2001' / 'sample3.ris') as s:
        ...
        assert result == {
            ...
            Tags.RP: 'Not In File',
            Tags.CY: 'Detroit MI',
            Tags.KW: ['risk', 'AIDS', 'models', 'sexual behavior', 'HIV', 'condoms', 'heterosexual', 'bisexual', 'ethnicity', 'women'],
